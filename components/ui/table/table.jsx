                    ...
                    : column.key === "action" ? (
                      ...
                      : column.key === "actions" ? (
                        <div className="flex items-center gap-x-3">
                          <button className={`px-8 py-2 rounded-md bg-placeholderText  text-lg capitalize font-medium hover:scale-90 hover:duration-150 duration-150`}>Unlock</button>
                          <button className={`px-8 py-2 rounded-md bg-secondaryText text-lg capitalize font-medium hover:scale-90 hover:duration-150 duration-150`}>Edit</button>
