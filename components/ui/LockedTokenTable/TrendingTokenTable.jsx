                        ...
                        <tr key={index} className="border-b border-bordercolor hover:bg-bordercolor/20 transition-colors bg-[#1D1D1E4D] w-full">
                            ...
                            <td className="p-3">
                                <div className="flex items-center space-x-2">
                                    <span className="flex items-center gap-x-2"><Clock size={14} /> {token?.created}</span>
                                </div>
                            </td>
                            <td className="p-3 font-mono text-positive">{token.mtk_cap}</td>
                            <td className="p-3  font-medium">icon {token.liquidity} <span className='text-placeholderText'> / {token.liquidity}</span></td>
                            <td className="p-3 font-mono">
                                <div className="flex flex-col items-start">
                                    <p>{token.txns}</p>
                                    <span className='text-positive'>{token.txns} <span className='text-placeholderText'>/</span> <span className='text-negative'>{token.txns}</span> </span>
                                </div>
                            </td>
                            ...
                            <td className="p-3 font-bold text-positive">{token.additional_info}</td>


                            {isQuickBuy && <td className="p-3">
